  ...
  <span className="font-medium text-indigo-900">Upload CSV</span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link
  href="/admin/test-curator-notes"
  className="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors"
>
  <svg className="w-6 h-6 text-purple-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
  <span className="font-medium text-purple-900">Test Curator Notes</span>
</Link>
...
>
  ...
  <span className="font-medium text-indigo-900">Generate QR Codes</span>
</Link>
